...
public class MainGui extends JFrame {
    ...
    public MainGui() {
        super("PwbD - rozpoznawanie liter");
    ...
    private void setCenterArea() {
        ...
        centerPanel.add(new JLabel("Trenuj jako:", SwingConstants.CENTER), gbc);
        ...
        trainButton = new JButton("Trenuj");
    ...
    private void setOnClicks() {
        ...
        helpButton.addActionListener(e -> {
            ...
            sb.append("Przetrenuj Twoją sieć 5000 razy\n");
            sb.append("\n");
            sb.append("Rysuj myszką. Lewy klawisz rysuje, prawy usuwa\n");
            sb.append("\n");
            sb.append("Kliknij \">>\" by zobaczyć wynik\n");
            sb.append("\n");
            sb.append("Kliknij \"Trenuj\" by nauczyć się innej litery\n");
            JOptionPane.showMessageDialog(this, sb.toString(), "Pomoc", JOptionPane.PLAIN_MESSAGE);
        });
        ...
        trainNetworkButton.addActionListener(e -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Popraw dane", "ERROR", JOptionPane.PLAIN_MESSAGE);
            }
